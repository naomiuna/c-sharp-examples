...
namespace Mav.API.Migrations
{
    ...
    [Migration("20200612161123_AddedUserSectionTimerTable")]
    partial class AddedUserSectionTimerTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mav.Data.Entities.UserAssessmentSection", b =>
                {
                    ...
                    b.Property<int?>("UserSectionTimerID");
                    ...
                    b.HasIndex("UserSectionTimerID")
                        .IsUnique()
                        .HasFilter("[UserSectionTimerID] IS NOT NULL");
            ...
            modelBuilder.Entity("Mav.Data.Entities.UserSectionTimer", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Mav.Data.Entities.Section", b =>
                {
                    ...
                    b.HasOne("Mav.Data.Entities.Timer", "Timer")
                        .WithOne("Section")
                        .HasForeignKey("Mav.Data.Entities.Section", "TimerID");
                });
            ...
            modelBuilder.Entity("Mav.Data.Entities.UserAssessmentSection", b =>
                {
                    ...
                    b.HasOne("Mav.Data.Entities.UserSectionTimer", "UserSectionTimer")
                        .WithOne("UserAssessmentSection")
                        .HasForeignKey("Mav.Data.Entities.UserAssessmentSection", "UserSectionTimerID");
                });
