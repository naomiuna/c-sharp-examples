...
@Component({
  selector: 'app-invigilators-wrapper',
  templateUrl: './invigilators-wrapper.component.html',
  styleUrls: ['./invigilators-wrapper.component.css']
})
export class InvigilatorsWrapperComponent extends AppComponentBase implements OnInit {

  @Input() id: number; // Centre ID

  public filterModel: UserSearchModel = new UserSearchModel();
  public searchModel: Paginate<InvigilatorListingModel> = new Paginate<InvigilatorListingModel>();
  ...
  ngOnInit() {
    ...
    .subscribe(
      r1 => {
        console.log(r1);
        this.yearList = r1;
        this.centreService.getCentreInvigilatorTotals(this.id)
        .subscribe(
          r2 => {
            console.log(r2);
  ...
  private searchRecords(): void {
    ...
    this.userService.getInvigilatorSearch(this.filterModel)
    .subscribe(
      r1 => {
