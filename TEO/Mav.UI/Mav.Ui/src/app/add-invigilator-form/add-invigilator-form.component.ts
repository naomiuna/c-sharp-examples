...
@Component({
  selector: 'app-add-invigilator-form',
  templateUrl: './add-invigilator-form.component.html',
  styleUrls: ['./add-invigilator-form.component.css']
})
export class AddInvigilatorFormComponent extends AppComponentBase implements OnInit {

  public userDetails: AddInvigilatorViewModel = new AddInvigilatorViewModel();

  public addInvigilatorForm: FormGroup;
  public canAddMore = true;

  public get firstName(): AbstractControl { return this.addInvigilatorForm.get('FirstName'); }
  public get surname(): AbstractControl { return this.addInvigilatorForm.get('Surname'); }
  public get email(): AbstractControl { return this.addInvigilatorForm.get('Email'); }
  ...
  public submitForm(event) {
    this.validationService.markFormGroupTouched(this.addInvigilatorForm);
  ...
  public addAnother(): void {
    this.refreshScreenSkipLocation('/add-invigilator');
  }
  ...
  public saveChanges(addMore: boolean): void {
    ...
    if (!this.addInvigilatorForm.valid) {
      this.validationService.validateForm(this.addInvigilatorForm, false, true);
      return;
    }
  ...
  public addUser(): Observable<GenericResult<string>> {
    const endPoint = `${environment.apiBase + this.globalSettingsService.apiUserEndpoints.createExamInvigilator}`;
    const options = {
    ...
    return this.http.post<AddInvigilatorViewModel>(endPoint, this.userDetails, options)
      .pipe(
  ...
  private buildForm(): void {
    this.addInvigilatorForm = this.fb.group({
    ...
    this.validationService.setFormFields(this.addInvigilatorForm);

    // on each value change we call the validateForm function
    // We only validate form controls that are dirty, meaning they are touched
    // the result is passed to the formErrors object
    this.validationService.detectChangesInForm(this.addInvigilatorForm);
  }
