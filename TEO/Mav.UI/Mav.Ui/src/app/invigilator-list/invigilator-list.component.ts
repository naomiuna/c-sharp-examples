...
@Component({
  selector: 'app-invigilator-list',
  templateUrl: './invigilator-list.component.html',
  styleUrls: ['./invigilator-list.component.css']
})
export class InvigilatorListComponent extends AppComponentBase implements OnInit {
  ...
  ngOnInit() {
    ...
    .subscribe(
      r1 => {
        console.log(r1);
        this.yearList = r1;
        this.centreService.getCentreInvigilatorTotals(0)
        .subscribe(
          r2 => {
            console.log(r2);
