...
@Component({
  selector: 'app-assessments-section-edit-statement',
  templateUrl: './assessments-section-edit-statement.component.html',
  styleUrls: ['./assessments-section-edit-statement.component.css']
})
export class AssessmentsSectionEditStatementComponent extends AppAdminAssessmentBase implements OnInit {
  ...
  ngOnInit() {
    ...
    this.statementService.getStatementBySectionId<UpdateStatementViewModel>(this.id)
      ...
      .subscribe(
        r1 => {
          ...
          this.statementDetails.statementType = EnumStatementType.Section;
